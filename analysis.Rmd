...
pH_data <- pH_data %>%
  ...
  dplyr::mutate(ID = case_when((Treatment == "Fridge" & Weeks == 0) ~ 1,
                               (Treatment == "Fridge" & Weeks == 7) ~ 2,
                               (Treatment == "Fridge" & Weeks == 24) ~ 3,
                               (Treatment == "Dry" & Weeks == 0) ~ 4,
                               (Treatment == "Dry" & Weeks == 7) ~ 5,
                               (Treatment == "Dry" & Weeks == 24) ~ 6,
                               (Treatment == "Frozen" & Weeks == 0) ~ 7,
                               (Treatment == "Frozen" & Weeks == 7) ~ 8,
                               (Treatment == "Frozen" & Weeks == 24) ~ 9,))
...
```
```{r}
pH_data$ID <- as.integer(pH_data$ID)
...
```{r}
pH.MAN <- RM(pH ~ Treatment*Weeks, data = pH_data,
                 subject = "ID", within = "Weeks")
