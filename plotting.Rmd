...
```{r}
 ...
 pH.plot <- ggplot(tidyDataDry, aes(x = Weeks, y = pH)) +
...
pH.plot + showSignificance(c(1,2), 6.67, -0.05, "***", panel = list(Treatment = "Fridge")) + 
          showSignificance(c(2,3), 6.64, -0.05, "***", panel = list(Treatment = "Fridge")) +
          showSignificance(c(1,3), 6.6, -0.05, "***", panel = list(Treatment = "Fridge"))
